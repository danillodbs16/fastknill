...
def compute_euler(object D, float cutoff=np.inf, n_neighbors=None, int max_dim=1, mapped_nodes=False):
...
def compute_knill(object D, float cutoff=np.inf, n_neighbors=None, int max_dim=1, mapped_nodes=False):
